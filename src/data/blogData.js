export const blogs = [
  {
    ...
    date: "July 21, 2025", 
    content: [
      { type: "paragraph", text: "In today’s fast-evolving digital landscape, the way we teach, learn, and grow professionally is undergoing a fundamental shift. Education and training are no longer confined to physical classrooms or traditional methods. Digitalization is reshaping the future of learning, making it more accessible, personalized, and effective than ever before." },
      { type: "paragraph", text: "At Mentric Technologies, we are at the forefront of this transformation—creating intelligent, scalable solutions that empower educators, inspire learners, and support institutions in building a smarter tomorrow." },
      { type: "heading", text: "Why Digitalization Matters in Education and Training" },
      { type: "paragraph", text: "Digital transformation in education isn’t just a trend—it’s a necessity. Here’s why:" },
      ...
      { type: "heading", text: "How Mentric Technologies is Leading the Change" },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    date: "July 21, 2025", 
    content: [
      { type: "paragraph", text: "In the past, training and upskilling were rigid, one-size-fits-all processes. But today, with the rise of Artificial Intelligence (AI), the landscape of learning has dramatically shifted. AI is no longer just a futuristic concept—it is actively reshaping how individuals and organizations train, learn, and grow." },
      { type: "paragraph", text: "Whether in classrooms or corporate boardrooms, AI is driving personalized, data-driven, and efficient training experiences like never before." },
      { type: "heading", text: "Understanding AI’s Role in Training" },
       { type: "paragraph", text: "AI in training refers to the use of intelligent systems and algorithms to create, deliver, and manage learning content more effectively. From adaptive learning platforms to automated assessments and chatbots, AI enhances every layer of the training experience." },
      { type: "paragraph", text: "Some of the most impactful applications include:" },
      ...
      { type: "heading", text: "Why AI Matters in Modern Training" },
      {
        type: "paragraph",
      ...
      { type: "heading", text: "Industries Leading the AI Training Revolution" },
      {
        type: "paragraph",
      ...
      { type: "heading", text: "Real Impact: What AI-Enhanced Training Looks Like" },
      {
        type: "paragraph",
        text: "As digital technology continues to evolve, so does the potential for smarter, more inclusive, and impactful learning. Whether it’s in schools, universities, or corporate training environments, the fusion of education and technology holds the key to future-ready generations."
      },
      ...
      { type: "heading", text: "The Future of AI in Training" },
      {
        type: "paragraph",
